...
description: Use when user wants to validate a design doc via multi-session Q&A; adds `COMMENT(claude)` annotations. Argument: doc path. Do NOT use to create or execute design documents.
